...
Start with the
[certificate-to-Gate quickstart](https://github.com/sekosai/schemen-gate/blob/v1.0.3/examples/ai_pki_quickstart.py),
then read the
[architecture](https://github.com/sekosai/schemen-gate/blob/v1.0.3/docs/ARCHITECTURE.md),
[X.509 profile](https://github.com/sekosai/schemen-gate/blob/v1.0.3/docs/X509_PROFILE.md),
and
[production deployment contract](https://github.com/sekosai/schemen-gate/blob/v1.0.3/docs/PRODUCTION_DEPLOYMENT.md).
...
[path-specific license map](https://github.com/sekosai/schemen-gate/blob/v1.0.3/research/cdp/LICENSES.md).
Browse the
[publication bundle](https://github.com/sekosai/schemen-gate/tree/v1.0.3/research/cdp)
